            ...
            <ul class="pagination">
              ...
              >
                <nuxt-link
                  ...
                  :to="{
                    name: 'home',
                    query: {page: numb, tag: $route.query.tag, tab: tabName},
                  }"
                >
                  {{ numb }}
                </nuxt-link>
...
import {requestAll} from "@/plugins/request";
...
export default {
  ...
  async asyncData({
    ...
    articlesData.data.articles.forEach(
    ...
    return {
      ...
      page,
      limit,
      tags: Array.isArray(tagsData.data.tags)
        ? tagsData.data.tags.filter((item) => item)
        : [],
      tag: query.tag,
      tabName: tabName,
    };
